...
class UserController extends Controller
{
    ...
    public function createUser(Request $request)
    {
        ...
        try {
            ...
            //Check if the user is exist, return the first column
            $user = User::where($map)->first();

            //Whether the user has already logged in or not
            /*Empty means does not exist, then save the user in the database
            for the first time */
            if(empty($user -> id)) {
